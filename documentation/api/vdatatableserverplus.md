...
const propsRows = [
  {
    name: 'headers',
    type: `All default VDataTableServer header properties plus:<br/>isShow, filterable, filterType, filterMode, allFilterValue, filterValue, filterItems, draggable, fixable`,
    default: 'required',
  ...
  { name: 'table-class', type: 'string | object | array', default: 'undefined', detail: 'Custom class for internal `v-data-table-server` root.' },
  { name: 'table-style', type: 'string | object | array', default: 'undefined', detail: 'Custom style for internal `v-data-table-server` root.' },
  ...
  { name: 'data-table-props', type: 'Record<string, any>', default: '{}', detail: 'Pass-through props spread to internal `v-data-table-server`.' },
...
const slotsRows = [
  ...
  { name: 'header-commands', slotProps: '{ clearSearch }', detail: 'Right side of toolbar actions.' },
...
All base [VDataTableServer](https://vuetifyjs.com/en/api/v-data-table-server) props/events/slots are supported. Use `table-height` instead of `height`.
